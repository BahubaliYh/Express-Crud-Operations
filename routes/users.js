...
app.post('/add', function(req, res, next) {
    req.assert('name', 'Program Name is required').notEmpty() //Validate name
    req.assert('age', 'Year is required').notEmpty() //Validate age
    req.assert('email', 'A Type is required').notEmpty() //Validate email
...
app.put('/edit/(:id)', function(req, res, next) {
    req.assert('name', 'Program is required').notEmpty() //Validate name
    req.assert('age', 'Year is required').notEmpty() //Validate age
    req.assert('email', 'A Program Type is required').notEmpty() //Validate email
